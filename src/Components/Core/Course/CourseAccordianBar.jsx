...
function CourseAccordianBar({course, isActive, handleActive}) {
  ...
  return (
    ...
    <div ref={contentEl} className={`relative h-0 overflow-hidden bg-richblack-900 transition-[height] duration-[0.35s] ease-[ease]`} style={{

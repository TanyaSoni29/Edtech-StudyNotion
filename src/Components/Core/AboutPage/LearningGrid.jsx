...
const LearningGridArray = [
    {
        ...
        description: "Studynotion partners with more than 275+ leading universities and companies to bring flexible, affordable, job-relevent online learning to individuals and organisations worldwide.",
        BtnText : "Learn More",
        BtnLink: "/"
    },
    {
  ...
  return (
    <div className='grid mx-auto w-[350px] xl:w-fit grid-cols-1 xl:grid-cols-4 mb-12'>
    {
        LearningGridArray.map( (card,i) => {
            return (
                <div key={i} className={`${i=== 0 && "xl:col-span-2 xl:h-[294px]"} ${

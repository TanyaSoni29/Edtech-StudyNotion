...
function VideoDetailsSidebar({setReviewModal}) {
  ...
  return (
    ...
    }} className='flex h-[35px] w-[35px] items-center justify-center rounded-full bg-richblack-100 p-1 text-richblack-700 hover:scale-90' title='back'>
         ...
         justify-between bg-richblack-600 px-5 py-4'>
            ...
            {activeStatus === course?._id && (
                ...
                {course.subSection.map((topic, i) => (
                    <div className={`flex gap-3 px-5 py-2 ${videoBarActive === topic._id ? "bg-yellow-200 font-semibold text-richblack-800" : "hover:bg-richblack-900"}`} key={i} onClick={() => {

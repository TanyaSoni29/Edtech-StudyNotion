...
function MyProfile() {
  ...
  return (
    ...
    <h1 className='mb-14 text-3xl font-medium text-richblack-5'>
      ...
      <div className='flex items-center justify-between rounded-md border-[1px] border-r-richblack-700 bg-richblack-800 p-8 px-12'>
      ...
      <p className={`${user?.additionalDetails?.about ? "text-richblack-5" : "text-richblack-400" } font-medium text-sm `}>{user?.additionalDetails?.about ?? "Write Something About Yourself"}</p>
      ...
      <div><p className='mb-2 text-sm text-richblack-600'>Gender</p>
      <p className='text-sm font-medium text-richblack-5'>{user?.additionalDetails?.gender ?? "Add Gender"}</p></div>

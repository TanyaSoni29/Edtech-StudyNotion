...
function VerifyEmail() {
    ...
    const handelVerifyAndSignup =(e) => {
        e.preventDefault();
        const {accountType, firstName, lastName, email, password , confirmPassword} = signupData;
        dispatch(signUp(accountType, firstName, lastName, email, password, confirmPassword, otp, navigate))
    }
  return (
    <div className='min-h-[clac(100vh-3.5rem)] grid place-items-center'>
      {
        loading? <div className='spinner'></div> : (
            <div className='max-w-[500px] p-4 lg:p-8'>
                ...
                <form onSubmit={handelVerifyAndSignup}>
                <OTPInput value={otp} onChange={setOtp} numInputs={6} renderInput={(props) => (<input {...props} placeholder='-' style={{boxShadow:"inset 0px -1px 0px rgba(255, 255, 255, 0.18)"}}
                ...
                <Link to="/signup"><p className='text-richblack-5 flex items-center gap-x-2'><BiArrowBack/> Back To Signup</p></Link>
